  ...
  Josh.AC = function AC() {
    ...
    this.init = function init() {
      ...
      panelCount = function panelCount(count, panelNumber) {
        ...
        cd.x = (panel.x + panel.w) - countDown.width;
        cd.y = (panel.y + panel.h) - countDown.width;
        cd.addTextBottomRight(count + '', 'Griffy', 50, countDown.width - margin, countDown.width - margin);
      }.bind(this);
